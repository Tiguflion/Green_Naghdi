...
CALL flux_godunov_WB_Bord_Wall(W,X,F0,FNx,Nx,g)
	     ...
	     W(2,1) = 0._rp !W(2,1) - dt/dx*(Flux(2,1) - F0(2)) !-- La bathymétrie est identique aux indices 0 et 1
	     W(3,1) = W(3,2) !W(3,1) - dt/dx*(Flux(3,1) - F0(3))
	     W(4,1) = W(4,2) !- dt/dx*(Flux(4,1) - F0(4))
	     
	     W(1,Nx) = W(1,Nx-1)! W(1,Nx) - dt/dx*(FNx(1) - Flux(1,Nx))
	     W(2,Nx) = 0._rp !W(2,Nx) - dt/dx*(FNx(2) - Flux(2,Nx)) !-- La bathymétrie est identique aux indices Nx et Nx+1
